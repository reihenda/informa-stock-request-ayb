                ...
                <div key={i} className={`bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow ${
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400 mt-0.5 flex items-center gap-1.5 flex-wrap">
                        ...
                        {r.pareto && (
                          <span className={`font-bold px-1.5 py-0.5 rounded text-[10px] ${PRIORITY_PARETO.has(r.pareto) ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-500'}`}>
                            {r.pareto}
                          </span>
                        )}
                      </p>
                  ...
                  {isRejected && (
                    <div className="mt-2 bg-red-50 border border-red-100 rounded-lg px-3 py-2">
                      ...
                      {r.alasan
                        ? <p className="text-xs text-red-500">Alasan: {r.alasan}</p>
